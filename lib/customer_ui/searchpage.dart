...
void showSnackBar(String title){
  ...
  void searchPlacePick(String placeName) async {
    ...
    String url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?input=$placeName&key=AIzaSyAUqoje9DfiCojdYrICiT0643jh7N6stLc&sessiontoken=1234567890';
