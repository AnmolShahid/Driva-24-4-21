            ...
            child: Container(
              child: AppBar(
               ...
               // actions: [drawer?Icon(Icons.menu, color: DarkGray,):Container(), SizedBox(width: 10,)],
                leading:drawer?GestureDetector( onTap: () async {
                   await  HelperMethods.getCurrentUSerInfo();
                  keyScaf.currentState.openDrawer();}, child: Icon(Icons.menu, color: whtColor,),)
                :
                ...
                title:  Text('$title', style: TextStyle(fontSize:15, color: whtColor),),
                centerTitle: true,
              ),
            ));
}
class CusDrawerPage extends PreferredSize {
  ...
  errorWidget: (context, url, error) => Icon(Icons.error),
   ...
   errorWidget: (context, url, error) => new Icon(Icons.error),
                      ...
                      */  Text(list[0]["username"]??'Customer', style: TextStyle(color: whtColor, fontWeight: FontWeight.bold, fontSize: 20),),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(
                              list[0]["feedback"].toString()??'0.0', 
                            
                            style: TextStyle(color: whtColor, fontWeight: FontWeight.bold, fontSize: 16)),
                            Icon(Icons.star, size: 15,color: whtColor,)
                          ],
                        ),
                      ],
          ...
          return
            AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  Text('Helpline: +99 333 111', textAlign: TextAlign.center,),
                  SizedBox(height: 10,),
                ],
              ),
              actions: [
            ...
            onTap:(){
              ...
              child: Container(
                ...
                child: Text('Okay', style: TextStyle(color: whtColor, fontWeight: FontWeight.w500),),
              ),
            )
              ],
            );
